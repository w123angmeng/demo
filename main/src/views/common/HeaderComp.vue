<template>
    <div class="headerWrap fw">
        <div class="lw">
            ...
            <el-button type="primary" @click="changePatInfo"
                >切换患者信息</el-button
            >
        </div>
        <!-- <div class="rw">
...
export default {
    ...
    computed: {
        ...
        patientInfo() {
            console.log(
                "====computed检测到变化：",
                this.$store.state.patient.patientInfo
            );
        ...
        count() {
            console.log(
                "====computed检测到变化count：",
                this.$store.state.patient.count
            );
    ...
    mounted() {
        ...
        console.log("=================main mounted initGlobalState");
        this.actions = initGlobalState({global: true})
        console.log("=================main mounted initGlobalState")
